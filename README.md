...
## 👀 Demo
Para experimentar o projeto em ação, acesse a versão de demonstração [clicando aqui](https://NemesioCarlos.github.io/calculadora-web/).
...
$ git clone https://github.com/NemesioCarlos/calculadora-web.git
...
Este projeto está sob a licença MIT. Consulte a [LICENÇA](https://github.com/NemesioCarlos/calculadora-web/blob/main/LICENSE.md) para obter mais informações.
